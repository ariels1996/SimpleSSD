...
function = [
    ...
    ["ftl/page_mapping.cc", "add", 1, 41],
    ["ftl/page_mapping.cc", "addInternal", 1, 42],
    ["icl/icl.cc", "read", 2, 0],
    ...
    ["hil/nvme/namespace.cc", "add", 9, 41],
